...
CREATE TABLE `barang_sementaras` (
  ...
  CONSTRAINT `barang_sementaras_ibfk_2` FOREIGN KEY (`user`) REFERENCES `users` (`id`) ON DELETE CASCADE
...
CREATE TABLE `masuk_barangs` (
  ...
  CONSTRAINT `masuk_barangs_ibfk_2` FOREIGN KEY (`kode_supplier`) REFERENCES `suppliers` (`kode`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-02-22 22:20:55
